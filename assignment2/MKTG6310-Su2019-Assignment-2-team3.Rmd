...
##In my point of view ,Customer Attitude towards the use of Free Apps is subjective and it doesnot show any pattern with the race of the cust.omer ,Hence , q54 doesnot have any such significance .
set.seed(2143) 
...
predModel2=predict(logModel2,newdata=appHappyNu[appHappyNum$estSamp==FALSE,],type="response") 
summary(predModel2)
